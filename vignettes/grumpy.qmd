...
Note however we would usually push users towards more advanced and performant formats such as [Zarr](https://zarr-specs.readthedocs.io/en/latest/v3/core/) for large datasets. Zarr datasets are supported for example by the `{Rarr}` Bioconductor package.
